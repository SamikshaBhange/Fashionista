...
<body>
   ...
   <!--/content-inner-->
	...
	<div class="outter-wp">
								...
								<center><h1>One pieces </h1></center>
													<div class="graph">
														<div class="tables">
	...
	$sql="select * from  allproducts where category='one piece'";
 ...
 <td><a href="update_details2.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Update</a>
