...
<body>
   ...
   <!--/content-inner-->
	...
	<div class="outter-wp">
								...
								<center><h1>High-Heels </h1></center>
													<div class="graph">
														<div class="tables">
	...
	$sql="select * from  allproducts where category='heels'";
 ...
 <td><a href="update_details7.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Update</a>
