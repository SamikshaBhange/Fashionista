...
$result = mysql_query("SELECT * FROM sandel WHERE id=".$_GET['id']);
...
$sql="update sandel set product_name='$name',product_price='$price',product_brand='$brand',product_details='$details',product_img='$filename' where ID='$id'";
$abc=mysql_query($sql);
if($abc)
{
