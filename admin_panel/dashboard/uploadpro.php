   ...
   <!--/content-inner-->
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="look4.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="n8.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="n10.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
						...
						<center><br><br><a href="dashboard.php"><img src="back.jpg" height="50" width="50"></a></center>			
			...
			<!--/sidebar-menu-->
					...
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Upload Products</h1></span><br><br> 
				...
				<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Women's Acessories</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										...
										<li><a href="uploadproduct_bag.php"><i class="fa fa-tachometer"></i> <span>Women's Bags</span></a></li>
