...
<?php } ?>
  ...
  <input type="hidden" value="<?php echo $_SESSION['user_email']; ?>" name="cust_id">  
    ...
    <form action="../../buynow/buy/web/buynowform2.php?id=<?php echo $_GET['id'];?>" method="POST"  style="float:left;">
     <?php if(!isset($_SESSION['user_name'])){ ?>
...
$sql="INSERT INTO `cart` (`product_id`, `customer_id`) VALUES ('$prod_id','$cust_id')";
$execute_query=mysql_query($sql);
if($execute_query){
