...
<?php } ?>
  ...
  <input type="hidden" value="<?php echo $_SESSION['user_email']; ?>" name="cust_id">  
   <input type="hidden" value="<?php echo $_POST['product_name']; ?>" name="name">
    
  <input type="hidden" value="<?php echo $_GET['product_price']; ?>" name="price">  
    <input type="hidden" value="<?php echo $_GET['product_brand']; ?>" name="brand"> 
...
$sql="INSERT INTO `cart1` (product_id, customer_id,product_name,product_price,product_brand) VALUES ('$prod_id','$cust_id','$name','$price','$brand');";
$execute_query=mysql_query($sql);
if($execute_query){
