										...
										<div class="tab-content">
										  <div class="tab-pane active" id="women">
											<ul class="nav-list list-inline">
												...
												<li><a href="order.php.php">MY ORDERS</a></li>
...
mysql_select_db("fashionista");
	...
	$sql1="select * from  cart where customer_id='$cust_id' AND purchase_status='1'";
	...
	?>
     ...
     <tr>
     <td><font size="3" color="black"><?php  echo $row['id']; ?></font></td>
      <td><font size="3" color="black"><?php  echo $row['product_name']; ?></font></td>
       <td><font size="3" color="black"><?php  echo $row['product_price']; ?></font></td>
        <td><font size="3" color="black"><?php  echo $row['product_brand']; ?></font></td>
